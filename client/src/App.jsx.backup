                  ...
                  {ageCategory && (
                    <div className="space-y-2 animate-in slide-in-from-top-2 duration-300">
                      <label className="text-sm font-medium">
                        {ageCategory === 'bebé' ? 'Select age in months' : 'Select age in years'}
                      </label>
                      <Select value={age} onValueChange={setAge}>
                        <SelectTrigger className="text-lg">
                          <SelectValue placeholder={ageCategory === 'bebé' ? 'Select months' : 'Select years'} />
                        </SelectTrigger>
                        <SelectContent>
                          {ageCategory === 'bebé' ? (
                            // 1-12 months
                  ...
                  <div>
                    ...
                    <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                      ...
                      <p className="text-sm text-green-700 font-medium mt-2">
                        <strong>Note:</strong> Ibuprofeno does not interact with paracetamol and can be taken at the same time
                      </p>
                    </div>
